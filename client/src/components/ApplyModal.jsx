...
export default function ApplyModal({ opportunity, isOpen, onClose, onSuccess }) {
    ...
    return (
        <div style={{
            ...
            <div className="glass-card transition-all duration-300 hover:shadow-[0_0_25px_rgba(34,211,238,0.3)]"
                style={{
                ...
                {/* Header */}
                <div style={{
                    padding: "1.25rem 1.5rem", borderBottom: "1px solid rgba(34,211,238,0.15)",
                    display: "flex", justifyContent: "space-between", alignItems: "center"
                }}>
                    <div>
                        <h2 style={{ fontSize: "1.25rem", fontWeight: "700", color: "#e5e7eb", margin: 0 }}>Apply to {opportunity.title}</h2>
                        {opportunity.postedBy?.organization && (
                            <p style={{ margin: "0.25rem 0 0 0", fontSize: "0.85rem", color: "#9ca3af" }}>{opportunity.postedBy.organization}</p>
                        )}
                    </div>
